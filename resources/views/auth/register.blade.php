                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('register') }}">
                      @csrf
                      <div class="mb-3">
                        <x-jet-label for="name" value="{{ __('Tên của bạn') }}" class="form-label"/>
                        <x-jet-input
                          type="text"
                          class="form-control"
                          id="name"
                      ...
                      <div class="mb-3">
                        <x-jet-label for="email" class="form-label" value="{{ __('Tài khoản') }}"/>
                        <x-jet-input
                            type="email"
                            class="form-control"
                            id="email"
                      ...
                      <div class="mb-3 form-password-toggle">
                        <div class="d-flex justify-content-between">
                          <x-jet-label for="password_confirmation" class="form-label" value="{{ __('Xác nhận mật khẩu') }}"/>
                        </div>
                        <div class="input-group input-group-merge">
                          <x-jet-input
                            type="password"
                      ...
                      <div class="mb-3">
                        <x-jet-button class="btn btn-primary d-grid w-100">
                            {{ __('Đăng ký nhanh') }}
                        </x-jet-button>
                      </div>
                    </form>
